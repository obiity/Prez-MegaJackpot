...
export function PromoBanners() {
  return (
    <section className="py-12 bg-[var(--bg-base)] transition-colors duration-300">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 opacity-[0.03] mix-blend-overlay pointer-events-none" style={{ backgroundImage: "repeating-radial-gradient(circle at 0 0, transparent 0, transparent 10px, white 10px, white 11px), repeating-linear-gradient(-45deg, transparent 0, transparent 10px, white 10px, white 11px)" }} />
            ...
            <div className="relative z-10">
              ...
              <p className="text-rose-100 font-medium mb-8 max-w-xs drop-shadow-sm">
                Inscrivez-vous aujourd&apos;hui et recevez votre <strong className="text-white">premier ticket 100% offert</strong> pour le tirage de votre choix.
              </p>
          ...
          >
            {/* Guilloche Pattern Overlay */}
            <div className="absolute inset-0 opacity-[0.03] mix-blend-overlay pointer-events-none" style={{ backgroundImage: "repeating-radial-gradient(circle at 100% 100%, transparent 0, transparent 10px, white 10px, white 11px), repeating-linear-gradient(45deg, transparent 0, transparent 10px, white 10px, white 11px)" }} />
            
            {/* Shine Animation */}
            <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-[var(--color-mj-gold)]/20 to-transparent animate-[shimmer_3s_infinite] skew-x-12" style={{ animationDelay: '1.5s' }} />
            ...
            <div className="relative z-10">
              <div className="inline-block bg-[var(--color-mj-gold)]/10 backdrop-blur-md text-[var(--color-mj-gold)] text-[10px] font-bold px-3 py-1 rounded-full border border-[var(--color-mj-gold)]/30 mb-6 shadow-sm uppercase tracking-wider">
                PROGRAMME FIDÉLITÉ
              </div>
              <h3 className="font-heading text-3xl mb-3 text-[var(--color-mj-gold)] drop-shadow-md">Parrainez et Gagnez</h3>
              <p className="text-blue-100 font-medium mb-8 max-w-xs drop-shadow-sm">
                Invitez vos amis à jouer. Pour chaque filleul inscrit, recevez <strong className="text-white">des tickets gratuits</strong>.
              </p>
